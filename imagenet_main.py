...
from imagenet_single_set import imagenet_single_dataset_run
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', required=True, type=str,
        help='What model to use. Refer to Models_imagenet_pretrained/*.py  to see full options')


    parser.add_argument('--in_norm', required=False, type=str2bool, default=False,
        help='Whether imagenet normalisation should be applied')
    
    parser.add_argument('--in_resize', required=True, type=str2bool, default=False,
        help='Whether or not input samples should be resized according to standard imagenet processing.\
            This is a required argument as for transformers tis transform is necessary and should be noted')
    ...
    parser.add_argument('--n_way', required=False, type=int, default=5,
    ...
    # ImageNet processing control
    params['data']['in_norm'] = args['in_norm']
    params['data']['in_resize'] = args['in_resize']
    ...
    for idx, config_file in enumerate(data_params_file_list):
        ...
        with torch.no_grad():
            results = imagenet_single_dataset_run(params=params, 
